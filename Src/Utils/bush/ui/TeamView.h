...
class TeamView : public QFrame
{
  ...
  QPushButton* pbSave;
  QComboBox* cbFieldPlayerColor;
  QComboBox* cbGoalkeeperColor;
  QSpinBox* sbNumber;
...
private slots:
  void fieldPlayerColorChanged(const QString& color);
  void goalkeeperColorChanged(const QString& color);
