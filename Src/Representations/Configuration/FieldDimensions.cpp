...
void FieldDimensions::drawLines() const
{
  DEBUG_DRAWING("field lines", "drawingOnField")
  {
    ...
    POLYGON("field lines", 4, points, 0, Drawings::solidPen, ColorRGBA(10, 128, 10), Drawings::solidBrush, ColorRGBA(10, 128, 10));
...
void FieldDimensions::drawPolygons() const
{
  if(Blackboard::getInstance().exists("OwnTeamInfo") && Blackboard::getInstance().exists("OpponentTeamInfo"))
  {
    ...
    {
      // colours in the same order as RoboCupGameControlData.h 
      static const ColorRGBA colors[] =
      {
        ColorRGBA(50, 120, 127), // blue
        ColorRGBA(160, 30, 30), // red
        ColorRGBA(127, 120, 50), // yellow
        ColorRGBA(40, 40, 40), // black/dark-gray
        ColorRGBA(180, 180, 180), // white
        ColorRGBA(40, 180, 30), // green
        ColorRGBA(127, 120, 0), // orange
        ColorRGBA(120, 20, 127), // purple
