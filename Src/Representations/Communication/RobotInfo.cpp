...
std::string RobotInfo::getPenaltyString() const
{
  switch(penalty)
  {
...
std::string RobotInfo::getRobotAndColourString() const
{
  return fmt::format("{} {}",
...
bool RobotInfo::isPenalized() const
{
  return penalty != PENALTY_NONE;
}
