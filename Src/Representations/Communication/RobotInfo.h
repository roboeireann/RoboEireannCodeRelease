...
public:
  ...
  std::string getRobotAndColourString() const;

  bool isGoalkeeper() const;
  bool isPenalized() const;

  /** returns the zero-based index corresponding to the player number */
  int playerIndex() const { return number - Settings::lowestValidPlayerNumber; }
