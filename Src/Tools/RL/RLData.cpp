 ...
 * @file RLData.cpp
 * 
 * This file contains the implementation of the RLData class, which provides functions for saving trajectories,
 *  converting vectors to JSON arrays, and converting JSON arrays to vectors.
 * 
 * @author BadgerBots
 */
#include "RLData.h"
