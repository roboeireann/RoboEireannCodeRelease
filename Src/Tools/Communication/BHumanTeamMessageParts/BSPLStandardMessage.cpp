...
{
  static_assert(SPL_STANDARD_MESSAGE_STRUCT_VERSION == 23, "Please adjust this file to the newer version.");
...
void BSPLStandardMessage::read(In& stream)
{
  ...
  // NOTE: fields here must match SPLStandardMessage exactly
