...
public:
  ...
  Settings::TeamColor firstTeamFieldPlayerColor = static_cast<Settings::TeamColor>(-1); /**< Color of the first team. */
  Settings::TeamColor secondTeamFieldPlayerColor = static_cast<Settings::TeamColor>(-1); /**< Color of the second team. */
  Settings::TeamColor firstTeamGoalkeeperColor = static_cast<Settings::TeamColor>(-1); /**< Color of the first team. */
  Settings::TeamColor secondTeamGoalkeeperColor = static_cast<Settings::TeamColor>(-1); /**< Color of the second team. */
