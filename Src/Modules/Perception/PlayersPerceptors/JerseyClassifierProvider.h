...
class JerseyClassifierProvider : public JerseyClassifierProviderBase
{
   ...
   * @param teamColor The field player color index of the jersey color that should be detected.
   * @param otherColor The team color index of the other team playing.
