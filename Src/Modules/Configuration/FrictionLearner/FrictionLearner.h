 ...
 * 1. Start it: mr DummyRepresentation FrictionLearner Cognition
 ...
 * 
 * RV note: The key value is a, the ballFriction which should eventually be copied to 
 * ballSpecification.cfg
 */
