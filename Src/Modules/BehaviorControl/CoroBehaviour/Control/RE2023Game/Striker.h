...
namespace RE2023
{
  ...
  private:
    DEFINES_PARAMS(StrikerKickoffTask,
    {,
      (Angle)(5_deg) minKickSectorSize, // higher values are less likely to shoot from kickoff (but would have a better chance of succeeding)
    ...
    Angle calcKickoffAngle()
    {
      ...
      Vector2f target = theRobotPose.toRobotCoordinates(goalCenterOnField);
