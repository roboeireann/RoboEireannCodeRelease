...
private:
  ...
  // allow setting a custom pose from SimRobot
  ENUM(DefendingHalf, {, left, right, none, }); // half as seen from the GC desk

  STREAMABLE(OverridePose,
  {,
    (DefendingHalf)(none) defendingHalf,
    (Pose2f)(Pose2f()) pose,
  });
