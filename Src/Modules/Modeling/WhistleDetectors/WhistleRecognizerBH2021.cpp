/**
 * @file WhistleRecognizerBH2021.cpp
 *
...
#include "WhistleRecognizerBH2021.h"
...
MAKE_MODULE(WhistleRecognizerBH2021, modeling);

static DECLARE_SYNC;

WhistleRecognizerBH2021::WhistleRecognizerBH2021()
{
...
void WhistleRecognizerBH2021::update(Whistle& theWhistle)
{
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation0");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation1");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation2");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation3");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation4");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:correlation5");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:samples0");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:samples1");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:samples2");
  DECLARE_PLOT("module:WhistleRecognizerBH2021:samples3");
  ...
  MODIFY("module:WhistleRecognizerBH2021:select", selectedName);
  ...
  // Record a whistle.
  DEBUG_RESPONSE_ONCE("module:WhistleRecognizerBH2021:record")
  {
  ...
  for(size_t i = 0; i < buffers.size(); ++i)
    if(!buffers[i].empty())
      switch(i)
      {
        case 0: PLOT("module:WhistleRecognizerBH2021:samples0", buffers[i].back()); break;
        case 1: PLOT("module:WhistleRecognizerBH2021:samples1", buffers[i].back()); break;
        case 2: PLOT("module:WhistleRecognizerBH2021:samples2", buffers[i].back()); break;
        case 3: PLOT("module:WhistleRecognizerBH2021:samples3", buffers[i].back()); break;
      }
  ...
  {
    COMPLEX_IMAGE("module:WhistleRecognizerBH2021:spectra")
    {
    ...
    for(auto& signature : signatures)
      if(selectedIter == signatures.end() || &signature == &*selectedIter)
      {
        ...
        if(defects < buffers.size())
        {
          ...
          {
            case 0: PLOT("module:WhistleRecognizerBH2021:correlation0", correlation); break;
            case 1: PLOT("module:WhistleRecognizerBH2021:correlation1", correlation); break;
            case 2: PLOT("module:WhistleRecognizerBH2021:correlation2", correlation); break;
            case 3: PLOT("module:WhistleRecognizerBH2021:correlation3", correlation); break;
            case 4: PLOT("module:WhistleRecognizerBH2021:correlation4", correlation); break;
            default: PLOT("module:WhistleRecognizerBH2021:correlation5", correlation); break;
          }
        }
      }
    ...
    if(bestSignature)
    {
      if(theFrameInfo.getTimeSince(theWhistle.lastTimeWhistleDetected) > minAnnotationDelay)
        ANNOTATION("WhistleRecognizerBH2021", bestSignature->name << " with " << static_cast<int>(bestCorrelation * 100.f) << "%");
  ...
  // FIXME - this logic is broken. Use accumulation time like BH2021 instead.
  // tmp commented out just to get compilation going.
  ...
  DEBUG_RESPONSE_ONCE("module:WhistleRecognizerBH2021:detectNow")
  {
    theWhistle.lastTimeWhistleDetected = theFrameInfo.time;
    theWhistle.confidenceOfLastWhistleDetection = 2.f;
  }

  SEND_DEBUG_IMAGE("module:WhistleRecognizerBH2021:spectra", canvas, PixelTypes::Edge2);
}

float WhistleRecognizerBH2021::correlate(std::vector<Vector2d>& signature, const RingBuffer<AudioData::Sample>& buffer,
                                      bool record)
{
