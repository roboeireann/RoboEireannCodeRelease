...
{,
  ...
  {,
    ...
    (int)(12000) minPenaltyTime, /**< The minimum time a robot must be penalized to actually believe it [ms]. */
...
class ExtendedGameInfoProvider : public ExtendedGameInfoProviderBase
{
  ...
  GameInfo::Mode modeLastFrame = GameInfo::Mode::unstiff;                                        /**< The mode that this robot had in the last frame. */
