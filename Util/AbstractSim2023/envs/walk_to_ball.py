...
class WalkToBallEnv(BaseEnv):
    ...
    def calculate_reward(self):
        ...
        return (1 / distance_robot_target * 1 / np.abs(self.relative_angle - self.robot_angle))
...
if __name__ == "__main__":
    ...
    env = VecNormalize.load(
        normalization_path, make_vec_env(WalkToBallEnv, n_envs=12)
    )
    env.norm_obs = True
