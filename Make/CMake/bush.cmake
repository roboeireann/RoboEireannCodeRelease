set(BUSH_ROOT_DIR "${PROJECTROOT_PREFIX}/Src")
...
list(APPEND BUSH_SOURCES
    ...
    "${BUSH_ROOT_DIR}/Tools/TextLogging.cpp" "${BUSH_ROOT_DIR}/Tools/TextLogging.h"
...
target_include_directories(bush SYSTEM PRIVATE "${BUSH_ROOT_DIR}/../Util/GameController/include")
target_include_directories(bush PRIVATE "${BUSH_ROOT_DIR}")
target_include_directories(bush PRIVATE $<$<PLATFORM_ID:Windows>:${PROJECTROOT_PREFIX}/Util/Buildchain/Windows/include>)
...
target_link_libraries(bush PRIVATE fmt)
