set(NAO_ROOT_DIR "${PROJECTROOT_PREFIX}/Src")
...
if(BUILD_NAO)
  ...
  set_property(TARGET Nao PROPERTY RUNTIME_OUTPUT_NAME roboeireann)
  ...
  target_link_libraries(Nao PRIVATE Nao::tflite::tflite_c_all_deps)
  ...
  target_link_libraries(Nao PRIVATE fmt)
