set(SIMULATEDNAO_ROOT_DIR "${PROJECTROOT_PREFIX}/Src")
...
if(${PLATFORM} STREQUAL Windows)
  add_library(SimulatedNao MODULE ${SIMULATEDNAO_SOURCES} $<TARGET_OBJECTS:Controller> "${PROJECTROOT_PREFIX}/Util/Buildchain/Windows/Visualizers/Angle.natvis")
else()
...
target_include_directories(SimulatedNao PRIVATE $<$<PLATFORM_ID:Windows>:${PROJECTROOT_PREFIX}/Util/Buildchain/Windows/include>)
...
target_link_libraries(SimulatedNao PUBLIC tflite::tflite_c_all_deps)
...
target_link_libraries(SimulatedNao PRIVATE fmt)
