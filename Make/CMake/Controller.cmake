set(CONTROLLER_ROOT_DIR "${PROJECTROOT_PREFIX}/Src")
...
if(${PLATFORM} STREQUAL Windows)
  add_library(Controller OBJECT EXCLUDE_FROM_ALL ${CONTROLLER_SOURCES} "${PROJECTROOT_PREFIX}/Util/Buildchain/Windows/Visualizers/Angle.natvis")
else()
...
target_include_directories(Controller PRIVATE $<$<PLATFORM_ID:Windows>:${PROJECTROOT_PREFIX}/Util/Buildchain/Windows/include>)
if(${PLATFORM} STREQUAL macOSarm64)
  target_include_directories(Controller SYSTEM PUBLIC "${PROJECTROOT_PREFIX}/Util/sse2neon/include")
endif()
...
target_link_libraries(Controller PRIVATE fmt)
if(NOT APPLE)
...
if(${PLATFORM} STREQUAL macOSarm64)
  target_include_directories(Controller SYSTEM PRIVATE "${PROJECTROOT_PREFIX}/Util/onnxruntime/lib/${PLATFORM}/onnxruntime.framework/Headers")
else()
